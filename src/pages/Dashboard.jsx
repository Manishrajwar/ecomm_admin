...
<div class="p-4 sm:ml-64  min-h-[100vh]">
 ...
 <CreateProduct updateProductId={updateProductId} setUpdateProductId={setUpdateProductId} updateCategoryId={updateCategoryId} setUpdateCategoryId={setUpdateCategoryId} token={token} setSelectedItem={setSelectedItem} />
   }

   {
      selectedItem === "createCategory" && 
   <CreateCategory updateProductId={updateProductId} setUpdateProductId={setUpdateProductId} setUpdateCategoryId={setUpdateCategoryId}  updateCategoryId={updateCategoryId} token={token} setSelectedItem={setSelectedItem} />
   }

   {
      selectedItem === "products"  && 
     <AllProducts updateProductId={updateProductId} setUpdateProductId={setUpdateProductId} updateCategoryId={updateCategoryId} setUpdateCategoryId={setUpdateCategoryId} token={token} setSelectedItem={setSelectedItem} />
   }

   {
      selectedItem === "users" && 
      <AllUsers updateProductId={updateProductId} setUpdateProductId={setUpdateProductId} updateCategoryId={updateCategoryId} setUpdateCategoryId={setUpdateCategoryId}  token={token} setSelectedItem={setSelectedItem} />
   }
   {
      selectedItem === "category" && 
      <AllCategory updateProductId={updateProductId} setUpdateProductId={setUpdateProductId} updateCategoryId={updateCategoryId} setUpdateCategoryId={setUpdateCategoryId}  token={token} setSelectedItem={setSelectedItem} />
   }
   {
      selectedItem === "paymentHistory" && 
      <PaymentHistory updateProductId={updateProductId} setUpdateProductId={setUpdateProductId} updateCategoryId={updateCategoryId} setUpdateCategoryId={setUpdateCategoryId}  token={token} setSelectedItem={setSelectedItem} />
   }
</div>
